...
import { setOrigin, setDestination } from "../store/slices/userSlice";
const HomeScreen = () => {
        ...
        >
          ...
          <View className="bg-green-300 h-[200] mt-4 py-2">
            ...
            >
              ...
              >
                <Text>TEST PINDAH CATEGORY</Text>
              </Pressable>

              <View className="bg-gray-200 w-[100] h-[70%] self-center ml-5 rounded-3xl"></View>
              ...
              <View className="bg-gray-200 w-[100] h-[70%] self-center ml-5 mr-5 rounded-3xl"></View>
            </ScrollView>
          </View>
          {/* END CATEGORY */}
